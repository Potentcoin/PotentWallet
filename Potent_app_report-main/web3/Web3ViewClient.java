...
import io.horizontalsystems.bankwallet.widget.AWalletAlertDialog;
...
public class Web3ViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        return shouldOverrideUrlLoading(view, url, true, true);
    }
    ...
    private boolean shouldOverrideUrlLoading(WebView webView, String url, boolean isMainFrame, boolean isRedirect) {
        ...
        Toast.makeText(context, "the url is " + urlToOpen, Toast.LENGTH_SHORT).show();
    ...
    {
        Toast.makeText(context, "unknown app is opening", Toast.LENGTH_SHORT).show();
